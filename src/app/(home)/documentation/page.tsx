      ...
      <main className="flex-1 pt-32 pb-40">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="text-center mb-40">
            ...
            <p className="text-slate-100 text-lg mt-4 font-bold tracking-[0.4em] uppercase opacity-60">
          ...
          <div ref={containerRef} className="relative">
            ...
            {docsData.map((section: any, index: number) => {
              ...
              return (
                <div
                  key={section.id}
                  className="relative mb-32 lg:mb-64 last:mb-0"
                >
                    ...
                    >
                      <Card className="bg-[#0a192f] border-white/5 rounded-[2.5rem] shadow-2xl overflow-hidden ring-1 ring-white/5 group hover:border-brand-primary/40 transition-all duration-500">
                        ...
                        <div className="p-8 space-y-6">
                          ...
                          <div className="space-y-3">
                            {section.technical_points.map(
                              (pt: any, i: number) => (
                                <div
                                  key={i}
                                  className="p-4 bg-brand-dark/60 rounded-2xl border border-white/10 hover:bg-brand-primary/[0.03] transition-colors"
                                >
                                  ...
                                  <p className="text-sm text-slate-100 leading-relaxed pl-6 opacity-80">
                                    {pt.detail}
                                  </p>
                                </div>
                              ),
            ...
            <div className="bg-[#05111b] rounded-[3.4rem] p-12 md:p-24 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-8 max-w-3xl">
                <h2 className="text-5xl md:text-7xl font-black italic tracking-tighter text-white uppercase leading-none">
                  Research <br />{" "}
                  <span className="text-brand-primary">Objective</span>
                </h2>
                <p className="text-xl md:text-2xl text-slate-100 leading-relaxed font-medium">
                  The ultimate goal of this platform is to reach{" "}
                  <span className="text-brand-primary font-black underline decoration-brand-primary/40 underline-offset-[10px]">
                    100% Precision and Recall
                  </span>
                  . By providing a transparent benchmarking environment, we
                  empower researchers to secure the modern web.
                </p>
